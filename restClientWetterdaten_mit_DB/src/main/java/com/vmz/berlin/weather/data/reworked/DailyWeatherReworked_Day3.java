...
@Entity
public class DailyWeatherReworked_Day3 {
	...
	// Constructors
	public DailyWeatherReworked_Day3() {
		
	}

	public DailyWeatherReworked_Day3(int dt, int sunrise, int sunset, TempObject_NestedInDailyReworked temp,
