...
@Entity
public class DailyWeatherReworked_Day7 {
	...
	// Constructors
	public DailyWeatherReworked_Day7() {
		
	}

	public DailyWeatherReworked_Day7(int dt, int sunrise, int sunset, TempObject_NestedInDailyReworked temp,
