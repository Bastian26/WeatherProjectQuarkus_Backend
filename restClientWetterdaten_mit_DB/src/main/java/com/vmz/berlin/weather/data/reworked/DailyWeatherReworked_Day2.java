...
@Entity
public class DailyWeatherReworked_Day2 {
	...
	// Constructors
	public DailyWeatherReworked_Day2() {
		
	}

	public DailyWeatherReworked_Day2(int dt, int sunrise, int sunset, TempObject_NestedInDailyReworked temp,
