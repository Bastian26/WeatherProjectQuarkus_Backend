...
@Entity
public class DailyWeatherReworked_Day4 {
	...
	// Constructors
	public DailyWeatherReworked_Day4() {
		
	}

	public DailyWeatherReworked_Day4(int dt, int sunrise, int sunset, TempObject_NestedInDailyReworked temp,
