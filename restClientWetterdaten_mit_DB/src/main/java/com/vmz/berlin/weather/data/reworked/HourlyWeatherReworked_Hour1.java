 ...
 */
@Entity
public class HourlyWeatherReworked_Hour1 {
	...
	//Constructors
	public HourlyWeatherReworked_Hour1() {
		
	}
	
	public HourlyWeatherReworked_Hour1(Integer idHourly, double temp, int clouds, HourlyNestedObjectReworked weather) {
		super();
