...
@Entity
public class DailyWeatherReworked_Day1 {
	...
	// Constructors
	public DailyWeatherReworked_Day1() {
		
	}

	public DailyWeatherReworked_Day1(int dt, int sunrise, int sunset, TempObject_NestedInDailyReworked temp,
