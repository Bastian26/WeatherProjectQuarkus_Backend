...
@Entity
public class DailyWeatherReworked_Day5 {
	...
	// Constructors
	public DailyWeatherReworked_Day5() {
		
	}

	public DailyWeatherReworked_Day5(int dt, int sunrise, int sunset, TempObject_NestedInDailyReworked temp,
